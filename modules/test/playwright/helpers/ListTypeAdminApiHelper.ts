...
export class ListTypeAdminApiHelper {
	...
	async postRandomListTypeDefinition() {
		...
		const listTypeEntryExternalReferenceCode =
			'ListTypeEntry' + getRandomInt();

		const requestBody = {
			externalReferenceCode: listTypeDefinitionExternalReferenceCode,
			listTypeEntries: [
				{
					externalReferenceCode: listTypeEntryExternalReferenceCode,
					key: listTypeEntryExternalReferenceCode,
					name: listTypeEntryExternalReferenceCode,
					name_i18n: {
						en_US: listTypeEntryExternalReferenceCode,
					},
				},
			],
