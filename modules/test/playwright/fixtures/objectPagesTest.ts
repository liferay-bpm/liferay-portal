...
import {ObjectFieldsFDSPage} from '../pages/object-web/object-fields/ObjectFieldsFDSPage';
...
const objectPagesTest = test.extend<{
	...
	objectFieldsFDSPage: ObjectFieldsFDSPage;
	...
	objectFieldsFDSPage: async ({page}, use) => {
		await use(new ObjectFieldsFDSPage(page));
	},
