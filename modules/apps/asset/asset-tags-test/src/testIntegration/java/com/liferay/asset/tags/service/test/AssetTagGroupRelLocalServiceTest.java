...
public class AssetTagGroupRelLocalServiceTest {
	...
	public void testGetAssetTagGroupRelsByGroupId() throws Exception {
		...
		_testGetAssetTagGroupRelsByGroupIdAndDepotEntryType();
	}
	...
	private void _testGetAssetTagGroupRelsByGroupIdAndDepotEntryType()
		throws Exception {
		...
		List<AssetTagGroupRel> projectAssetTagGroupRels =
			_assetTagGroupRelLocalService.
				getAssetTagGroupRelsByGroupIdAndDepotEntryType(
					group.getGroupId(), DepotConstants.TYPE_PROJECT);
		...
		_assertAssetTagGroupRel(
			projectAssetTagGroupRels.get(0), assetTag1.getTagId(),
			group.getGroupId());
		...
		_assertAssetTagGroupRel(
			spaceAssetTagGroupRels.get(0), assetTag2.getTagId(),
			group.getGroupId());
