...
public class NotificationQueueEntryPanelApp extends BasePanelApp {

	@Override
	public String getPortletId() {
		return NotificationPortletKeys.NOTIFICATION_QUEUE_ENTRY;
	}
	...
	@Override
	@Reference(
		target = "(javax.portlet.name=" + NotificationPortletKeys.NOTIFICATION_QUEUE_ENTRY + ")",
		unbind = "-"
	)
