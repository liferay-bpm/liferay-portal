...
public interface NotificationQueueEntryResource {
	...
	public HttpInvoker.HttpResponse getNotificationQueueEntryPageHttpResponse(
			String search, List<String> aggregations, String filterString,
			Pagination pagination, String sortString)
		throws Exception;
	...
	public static class NotificationQueueEntryResourceImpl
		...
		public Page<NotificationQueueEntry> getNotificationQueueEntryPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getNotificationQueueEntryPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/notification/v1.0/notification-queue-entry");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/notification/v1.0/notification-queue-entry/{notificationQueueEntryId}");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/notification/v1.0/notification-queue-entry/batch");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/notification/v1.0/notification-queue-entry/{notificationQueueEntryId}/resend");
