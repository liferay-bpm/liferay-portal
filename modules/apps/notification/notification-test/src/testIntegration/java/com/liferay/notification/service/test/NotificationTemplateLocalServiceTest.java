...
public class NotificationTemplateLocalServiceTest {
	...
	public void testAddNotificationTemplate() throws Exception {
		...
		String useMostRelevantLocaleForGuestUsers = String.valueOf(
				...
				NotificationTemplateUtil.createNotificationContext(
					...
					Arrays.asList(
						...
						NotificationTemplateUtil.
							createNotificationRecipientSetting(
								NotificationRecipientSettingConstants.
									NAME_USE_MOST_RELEVANT_LOCALE_FOR_GUEST_USERS,
		...
		_assertNotificationRecipientSetting(
			NotificationRecipientSettingConstants.
				NAME_USE_MOST_RELEVANT_LOCALE_FOR_GUEST_USERS,
			notificationRecipientId, useMostRelevantLocaleForGuestUsers);
	}
