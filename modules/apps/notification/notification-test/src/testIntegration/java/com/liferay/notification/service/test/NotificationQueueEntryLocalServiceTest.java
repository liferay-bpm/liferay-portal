...
public class NotificationQueueEntryLocalServiceTest {
	...
	@Test
	public void testDeleteNotificationQueueEntriesWithDeletedObjectDefinition()
		throws Exception {
		...
		Assert.assertFalse(
			"NotificationQueueEntry should have been created.",
			notificationQueueEntries.isEmpty());

		_objectDefinitionLocalService.deleteObjectDefinition(
			objectDefinition.getObjectDefinitionId());

		Assert.assertNull(
			"ObjectDefinition should have been deleted.",
		...
		Assert.assertEquals(
			"NotificationQueueEntry table should be empty.", 0,
	...
	private void _addNotificationTemplateObjectAction(
			String body, ObjectDefinition objectDefinition)
		throws Exception {
