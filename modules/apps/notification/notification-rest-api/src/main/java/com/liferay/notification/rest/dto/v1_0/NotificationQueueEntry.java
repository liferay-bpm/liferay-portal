...
public class NotificationQueueEntry implements Serializable {
	...
	public void setNotificationTemplateId(
		UnsafeSupplier<Long, Exception> notificationTemplateIdUnsafeSupplier) {

		try {
			notificationTemplateId = notificationTemplateIdUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
	...
	@GraphQLField
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	protected Long notificationTemplateId;
