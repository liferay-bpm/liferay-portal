...
import com.liferay.notification.exception.NotificationRecipientSettingException;
...
public class EmailNotificationType extends BaseNotificationType {
	...
	public void validateNotificationTemplate(
		...
		if (Validator.isNull(
			...
			throw new NotificationRecipientSettingException(
				"From Name is null");
		}

		if (Validator.isNull(notificationRecipientSettingsMap.get("to"))) {
			throw new NotificationRecipientSettingException("To is null");
		}
	}
