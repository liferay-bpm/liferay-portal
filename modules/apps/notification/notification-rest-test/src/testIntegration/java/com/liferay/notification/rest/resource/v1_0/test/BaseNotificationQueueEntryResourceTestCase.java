...
public abstract class BaseNotificationQueueEntryResourceTestCase {
	...
	@Test
	public void testGetNotificationQueueEntryPage() throws Exception {
		Page<NotificationQueueEntry> page =
			notificationQueueEntryResource.getNotificationQueueEntryPage(
				null, null, null, Pagination.of(1, 10), null);

		long totalCount = page.getTotalCount();

		NotificationQueueEntry notificationQueueEntry1 =
			testGetNotificationQueueEntryPage_addNotificationQueueEntry(
				randomNotificationQueueEntry());
		...
		page = notificationQueueEntryResource.getNotificationQueueEntryPage(
			null, null, null, Pagination.of(1, 10), null);
	...
	@Test
	public void testGetNotificationQueueEntryPageWithFilterDateTimeEquals()
		throws Exception {
	...
	@Test
	public void testGetNotificationQueueEntryPageWithFilterDoubleEquals()
		throws Exception {
	...
	@Test
	public void testGetNotificationQueueEntryPageWithFilterStringEquals()
		throws Exception {
	...
	@Test
	public void testGetNotificationQueueEntryPageWithPagination()
		throws Exception {
	...
	@Test
	public void testGetNotificationQueueEntryPageWithSortDateTime()
		throws Exception {

		testGetNotificationQueueEntryPageWithSort(
			EntityField.Type.DATE_TIME,
	...
	@Test
	public void testGetNotificationQueueEntryPageWithSortDouble()
		throws Exception {
	...
	@Test
	public void testGetNotificationQueueEntryPageWithSortInteger()
		throws Exception {
	...
	@Test
	public void testGetNotificationQueueEntryPageWithSortString()
		throws Exception {
	...
	protected void testGetNotificationQueueEntryPageWithSort(
	...
	protected void assertValid(NotificationQueueEntry notificationQueueEntry)
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
					"notificationTemplateId", additionalAssertFieldName)) {

				if (notificationQueueEntry.getNotificationTemplateId() ==
						null) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("notificationTemplateId")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}
