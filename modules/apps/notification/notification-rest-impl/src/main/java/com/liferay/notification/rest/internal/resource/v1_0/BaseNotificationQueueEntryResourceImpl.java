...
public abstract class BaseNotificationQueueEntryResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/notification/v1.0/notification-queue-entry'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/notification-queue-entry")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<NotificationQueueEntry> getNotificationQueueEntryPage(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/notification/v1.0/notification-queue-entry/{notificationQueueEntryId}'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/notification-queue-entry/{notificationQueueEntryId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/notification/v1.0/notification-queue-entry/batch'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.DELETE
	@javax.ws.rs.Path("/notification-queue-entry/batch")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/notification/v1.0/notification-queue-entry/{notificationQueueEntryId}'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
