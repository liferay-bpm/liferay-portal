...
public class DDMIndexerImplTest {
	...
	private void _testFormWithRepeatableSelectField() {
		...
		String optionKey = RandomTestUtil.randomString();
		...
		_ddmIndexer.addAttributes(
			...
			_createDDMFormValues(
				...
				DDMFormValuesTestUtil.createDDMFormFieldValue(
					_FIELD_NAME,
					DDMFormValuesTestUtil.createLocalizedValue(
						StringBundler.concat("[\"", optionKey, "\"]"),
						StringBundler.concat(
							"[\"", optionKey,
		...
		FieldValuesAssert.assertFieldValues(
			HashMapBuilder.put(
				...
				StringBundler.concat(
					"[[\"", StringUtil.toLowerCase(optionValue), "\"], [\"",
					StringUtil.toLowerCase(optionValue), "\"]]")
			).put(
				prefix + "_pt_BR",
				StringBundler.concat(
					"[[\"", optionKey,
					LocaleUtil.toLanguageId(LocaleUtil.BRAZIL), "\"], [\"",
					optionKey, LocaleUtil.toLanguageId(LocaleUtil.BRAZIL),
					"\"]]")
			).put(
