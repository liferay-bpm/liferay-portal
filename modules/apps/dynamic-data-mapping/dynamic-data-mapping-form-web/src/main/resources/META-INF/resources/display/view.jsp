			...
			<c:when test="<%= ddmFormDisplayContext.isFormAvailable() %>">
				...
				<div class="portlet-forms">
					<aui:form action="<%= addFormInstanceRecordActionURL %>" data-DDMFormInstanceId="<%= formInstanceId %>" data-senna-off="true" method="post" name="fm">
						...
						<liferay-ui:error exception="<%= ObjectEntryValuesException.IntegerSizeExceeded.class %>" message="object-entry-value-exceeds-maximum-integer-type-size" />
						...
						<liferay-ui:error exception="<%= ObjectEntryValuesException.MustBeLessThan280Characters.class %>" message="the-maximum-length-is-280-characters-for-text-fields" />
