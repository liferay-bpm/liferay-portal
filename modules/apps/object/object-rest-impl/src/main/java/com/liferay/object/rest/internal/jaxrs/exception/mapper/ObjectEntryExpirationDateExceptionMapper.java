 ...
 */
@Provider
public class ObjectEntryExpirationDateExceptionMapper
	extends BaseExceptionMapper<ObjectEntryExpirationDateException> {

	public ObjectEntryExpirationDateExceptionMapper(Language language) {
		_language = language;
	}

	@Override
	protected Problem getProblem(
		ObjectEntryExpirationDateException objectEntryExpirationDateException) {
