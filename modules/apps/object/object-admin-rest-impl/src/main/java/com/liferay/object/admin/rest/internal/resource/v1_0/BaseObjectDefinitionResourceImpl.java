...
public abstract class BaseObjectDefinitionResourceImpl
	...
	public ObjectDefinition patchObjectDefinition(
		...
		if (objectDefinition.getRootEntryScopingMode() != null) {
			existingObjectDefinition.setRootEntryScopingMode(
				objectDefinition.getRootEntryScopingMode());
		}
