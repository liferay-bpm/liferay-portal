...
public abstract class BaseObjectFolderResourceImpl
	...
	public void create(
		...
		UnsafeConsumer<ObjectFolder, Exception> objectFolderUnsafeConsumer =
			null;
		...
		if (StringUtil.equalsIgnoreCase(createStrategy, "INSERT")) {
			objectFolderUnsafeConsumer = objectFolder -> postObjectFolder(
				objectFolder);
		}
			...
			if (StringUtil.equalsIgnoreCase(updateStrategy, "PARTIAL_UPDATE")) {
				objectFolderUnsafeConsumer = objectFolder -> {
					try {
						...
						postObjectFolder(objectFolder);
					}
				};
			}
		}

		if (objectFolderUnsafeConsumer == null) {
		...
		if (contextBatchUnsafeConsumer != null) {
			contextBatchUnsafeConsumer.accept(
				objectFolders, objectFolderUnsafeConsumer);
		}
		else {
			for (ObjectFolder objectFolder : objectFolders) {
				objectFolderUnsafeConsumer.accept(objectFolder);
			}
		}
	}
	...
	public void update(
		...
		if (StringUtil.equalsIgnoreCase(updateStrategy, "PARTIAL_UPDATE")) {
			objectFolderUnsafeConsumer = objectFolder -> patchObjectFolder(
		...
		if (StringUtil.equalsIgnoreCase(updateStrategy, "UPDATE")) {
			objectFolderUnsafeConsumer = objectFolder -> putObjectFolder(
				objectFolder.getId() != null ? objectFolder.getId() :
					_parseLong((String)parameters.get("objectFolderId")),
				objectFolder);
		}
