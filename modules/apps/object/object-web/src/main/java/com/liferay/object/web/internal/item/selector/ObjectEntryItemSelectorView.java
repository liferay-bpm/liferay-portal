...
public class ObjectEntryItemSelectorView
	...
	private class ObjectItemSelectorViewDescriptor
			...
			try {
				Page<com.liferay.object.rest.dto.v1_0.ObjectEntry>
					objectEntriesPage = _objectEntryManager.getObjectEntries(
						...
						null, _getDTOConverterContext(),
						_getFilterString(_getOneToManyRelatedObjectEntries()),
						null, null, null);
		...
		private List<ObjectEntry> _getOneToManyRelatedObjectEntries()
			throws PortalException {
			...
			for (ObjectEntry relatedObjectEntry :
					_objectEntryLocalService.getObjectEntries(
						0, objectEntry.getObjectDefinitionId(),
