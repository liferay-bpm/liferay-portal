...
public class ObjectEntryInfoItemFieldValuesProvider
	...
	private List<InfoFieldValue<Object>>
		...
		objectEntryFieldValues.add(
			new InfoFieldValue<>(
				...
				serviceBuilderObjectEntry.getLastPublishDate()));
		objectEntryFieldValues.add(
			new InfoFieldValue<>(
		...
		objectEntryFieldValues.add(
			new InfoFieldValue<>(
				...
				ObjectEntryInfoItemUtil.getWebImage(
					_companyLocalService, serviceBuilderObjectEntry.getUserId(),
					_userLocalService)));
		...
		if (objectEntry != null) {
			objectEntryFieldValues.addAll(
				ObjectEntryInfoItemUtil.getObjectFieldsInfoFieldValues(
					...
					_objectScopeProviderRegistry, themeDisplay,
					objectEntry.getProperties()));
		}

		objectEntryFieldValues.addAll(
			ObjectEntryInfoItemUtil.getObjectActionsInfoFieldValues(
	...
	private List<InfoFieldValue<Object>>
		...
		objectEntryFieldValues.addAll(
			ObjectEntryInfoItemUtil.getObjectFieldsInfoFieldValues(
				_dlAppLocalService, _dlURLHelper, _objectDefinitionLocalService,
