...
@Component(
	property = {
		"javax.portlet.name=" + ObjectPortletKeys.OBJECT_FOLDERS,
		"mvc.command.name=/object_folders/export_object_folder"
	},
...
public class ExportObjectFolderMVCResourceCommand
	...
	protected void doServeResource(
		...
		String objectDefinitionJSON = objectFolderJSONObject.toString();
