...
describe('toCamelCase(str, removeSpecialCharacters, keepFirstLetterCase)', () => {
	it('returns first letter in uppercase', () => {
		expect(toCamelCase('FirstLetterUpperCase', false, true)).toBe('FirstLetterUpperCase');
	});

	it('returns first letter in lowercase', () => {
		expect(toCamelCase('firstLetterLowerCase', false, true)).toBe('firstLetterLowerCase');
	});

	it('removes special characters', () => {
		expect(toCamelCase('specialCharacter$', true, false)).toBe('specialCharacter');
	});
