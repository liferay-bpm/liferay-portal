...
function checkPostalAddressUnsupportedRelationship(
...
export function getUnsupportedRelationshipErrorMessage(
	nodes: Node<ObjectDefinitionNodeData>[],
	sourceNode: Node<ObjectDefinitionNodeData>,
	targetNode: Node<ObjectDefinitionNodeData>
) {
	...
	if (
		checkPostalAddressUnsupportedRelationship(nodes, sourceNode, targetNode)
	) {
		return {
			errorMessage: Liferay.Language.get(
				'not-possible-to-create-this-relationship'
			),
