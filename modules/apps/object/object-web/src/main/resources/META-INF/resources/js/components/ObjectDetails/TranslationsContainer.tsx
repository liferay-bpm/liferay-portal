				...
				<div className="lfr-objects-translations-container">
					<Toggle
						...
						tooltip={Liferay.Language.get(
							'enable-entry-translations-in-all-fields-go-to-field-settings-to-disable-translations-individually-this-configuration-cannot-be-changed-after-the-object-is-published'
						)}
					/>
				</div>
			</ClayPanel.Body>
