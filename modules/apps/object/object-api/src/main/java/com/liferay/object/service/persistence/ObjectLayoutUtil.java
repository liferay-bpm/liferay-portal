...
public class ObjectLayoutUtil {
	 ...
	 * @return the matching object layouts
	 */
	public static List<ObjectLayout> findByDefaultObjectLayout(
		boolean defaultObjectLayout) {

		return getPersistence().findByDefaultObjectLayout(defaultObjectLayout);
	}
	...
	public static List<ObjectLayout> findByDefaultObjectLayout(
		...
		return getPersistence().findByDefaultObjectLayout(
			defaultObjectLayout, start, end);
	}
	...
	public static List<ObjectLayout> findByDefaultObjectLayout(
		...
		return getPersistence().findByDefaultObjectLayout(
			defaultObjectLayout, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchObjectLayoutException if a matching object layout could not be found
	 */
	public static ObjectLayout findByDefaultObjectLayout_First(
			boolean defaultObjectLayout,
			OrderByComparator<ObjectLayout> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectLayoutException {

		return getPersistence().findByDefaultObjectLayout_First(
	 ...
	 * @return the first matching object layout, or <code>null</code> if a matching object layout could not be found
	 */
	public static ObjectLayout fetchByDefaultObjectLayout_First(
		boolean defaultObjectLayout,
		OrderByComparator<ObjectLayout> orderByComparator) {

		return getPersistence().fetchByDefaultObjectLayout_First(
			defaultObjectLayout, orderByComparator);
	}
	 ...
	 * @throws NoSuchObjectLayoutException if a matching object layout could not be found
	 */
	public static ObjectLayout findByDefaultObjectLayout_Last(
			boolean defaultObjectLayout,
			OrderByComparator<ObjectLayout> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectLayoutException {

		return getPersistence().findByDefaultObjectLayout_Last(
			defaultObjectLayout, orderByComparator);
	}
	 ...
	 * @return the last matching object layout, or <code>null</code> if a matching object layout could not be found
	 */
	public static ObjectLayout fetchByDefaultObjectLayout_Last(
		boolean defaultObjectLayout,
		OrderByComparator<ObjectLayout> orderByComparator) {

		return getPersistence().fetchByDefaultObjectLayout_Last(
			defaultObjectLayout, orderByComparator);
	}
	 ...
	 * @throws NoSuchObjectLayoutException if a object layout with the primary key could not be found
	 */
	public static ObjectLayout[] findByDefaultObjectLayout_PrevAndNext(
			long objectLayoutId, boolean defaultObjectLayout,
			OrderByComparator<ObjectLayout> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectLayoutException {

		return getPersistence().findByDefaultObjectLayout_PrevAndNext(
			objectLayoutId, defaultObjectLayout, orderByComparator);
	}
	 ...
	 * @param defaultObjectLayout the default object layout
	 */
	public static void removeByDefaultObjectLayout(
		boolean defaultObjectLayout) {

		getPersistence().removeByDefaultObjectLayout(defaultObjectLayout);
	}
	 ...
	 * @return the number of matching object layouts
	 */
	public static int countByDefaultObjectLayout(boolean defaultObjectLayout) {
		return getPersistence().countByDefaultObjectLayout(defaultObjectLayout);
	}
