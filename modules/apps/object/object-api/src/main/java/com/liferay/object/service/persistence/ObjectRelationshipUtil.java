...
public class ObjectRelationshipUtil {
	 ...
	 * @return the matching object relationships
	 */
	public static List<ObjectRelationship> findByODI2_DT_R_T(
		long objectDefinitionId2, String deletionType, boolean reverse,
		String type) {

		return getPersistence().findByODI2_DT_R_T(
	 ...
	 * @throws NoSuchObjectRelationshipException if a matching object relationship could not be found
	 */
	public static ObjectRelationship findByODI2_DT_R_T_First(
			long objectDefinitionId2, String deletionType, boolean reverse,
			String type,
			OrderByComparator<ObjectRelationship> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectRelationshipException {

		return getPersistence().findByODI2_DT_R_T_First(
			objectDefinitionId2, deletionType, reverse, type,
			orderByComparator);
	}
	 ...
	 * @return the first matching object relationship, or <code>null</code> if a matching object relationship could not be found
	 */
	public static ObjectRelationship fetchByODI2_DT_R_T_First(
		long objectDefinitionId2, String deletionType, boolean reverse,
		String type, OrderByComparator<ObjectRelationship> orderByComparator) {

		return getPersistence().fetchByODI2_DT_R_T_First(
			objectDefinitionId2, deletionType, reverse, type,
			orderByComparator);
	}
	 ...
	 * @throws NoSuchObjectRelationshipException if a matching object relationship could not be found
	 */
	public static ObjectRelationship findByODI2_DT_R_T_Last(
			long objectDefinitionId2, String deletionType, boolean reverse,
			String type,
			OrderByComparator<ObjectRelationship> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectRelationshipException {

		return getPersistence().findByODI2_DT_R_T_Last(
			objectDefinitionId2, deletionType, reverse, type,
			orderByComparator);
	}
	 ...
	 * @return the last matching object relationship, or <code>null</code> if a matching object relationship could not be found
	 */
	public static ObjectRelationship fetchByODI2_DT_R_T_Last(
		long objectDefinitionId2, String deletionType, boolean reverse,
		String type, OrderByComparator<ObjectRelationship> orderByComparator) {

		return getPersistence().fetchByODI2_DT_R_T_Last(
			objectDefinitionId2, deletionType, reverse, type,
			orderByComparator);
	}
	 ...
	 * @throws NoSuchObjectRelationshipException if a object relationship with the primary key could not be found
	 */
	public static ObjectRelationship[] findByODI2_DT_R_T_PrevAndNext(
			long objectRelationshipId, long objectDefinitionId2,
			String deletionType, boolean reverse, String type,
			OrderByComparator<ObjectRelationship> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectRelationshipException {

		return getPersistence().findByODI2_DT_R_T_PrevAndNext(
			objectRelationshipId, objectDefinitionId2, deletionType, reverse,
			type, orderByComparator);
	}
	 ...
	 * @param type the type
	 */
	public static void removeByODI2_DT_R_T(
		long objectDefinitionId2, String deletionType, boolean reverse,
		String type) {

		getPersistence().removeByODI2_DT_R_T(
			objectDefinitionId2, deletionType, reverse, type);
	}
	 ...
	 * @return the number of matching object relationships
	 */
	public static int countByODI2_DT_R_T(
		long objectDefinitionId2, String deletionType, boolean reverse,
		String type) {

		return getPersistence().countByODI2_DT_R_T(
			objectDefinitionId2, deletionType, reverse, type);
	}
