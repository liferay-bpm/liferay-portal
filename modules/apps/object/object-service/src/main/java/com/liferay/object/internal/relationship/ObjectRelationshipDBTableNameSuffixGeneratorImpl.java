...
public class ObjectRelationshipDBTableNameSuffixGeneratorImpl
	implements ObjectRelationshipDBTableNameSuffixGenerator {

	@Override
	public String generate(int objectRelationshipCount) {
		if (objectRelationshipCount > _RELATIONSHIP_MAXIMUM_CAPACITY) {
	...
	private static final int _RELATIONSHIP_MAXIMUM_CAPACITY = 67599;
