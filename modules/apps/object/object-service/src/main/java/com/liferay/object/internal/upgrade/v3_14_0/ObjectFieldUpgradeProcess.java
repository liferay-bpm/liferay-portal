...
package com.liferay.object.internal.upgrade.v3_14_0;
...
public class ObjectFieldUpgradeProcess extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		try (PreparedStatement preparedStatement = connection.prepareStatement(
			StringBundler.concat("SELECT ObjectDefinition.objectDefinitionId, ",
				"ObjectDefinition.companyId, ObjectDefinition.userid, ",
				"ObjectDefinition.dbTableName FROM ObjectDefinition WHERE ",
				...
				"\"dateCreated\" or ObjectField.name = \"dateModified\" or ",
				"ObjectField.name = \"id\" or ObjectField.name = \"status\") ",
			...
			while (resultSet.next()) {
				...
				_objectFieldLocalService.addSystemObjectField(
					...
					"ObjectEntry", "Date", false, false, null,
				...
				_objectFieldLocalService.addSystemObjectField(
					...
					resultSet.getString("dbTableName"), "Integer", false, false,
					null,
					LocalizedMapUtil.getLocalizedMap(
						LanguageUtil.get(
							LocaleUtil.fromLanguageId(
				...
				_objectFieldLocalService.addSystemObjectField(
					...
					ObjectEntryTable.INSTANCE.status.getName(), "ObjectEntry",
				...
				_objectFieldLocalService.addSystemObjectField(
					userId, objectDefinitionId, "Text",
					ObjectEntryTable.INSTANCE.userName.getName(), "ObjectEntry",
