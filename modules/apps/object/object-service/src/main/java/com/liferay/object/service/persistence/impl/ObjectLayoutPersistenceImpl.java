...
public class ObjectLayoutPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByDefaultObjectLayout;
	private FinderPath _finderPathWithoutPaginationFindByDefaultObjectLayout;
	private FinderPath _finderPathCountByDefaultObjectLayout;

	/**
	 * Returns all the object layouts where defaultObjectLayout = &#63;.
	 *
	 * @param defaultObjectLayout the default object layout
	 * @return the matching object layouts
	 */
	@Override
	public List<ObjectLayout> findByDefaultObjectLayout(
		boolean defaultObjectLayout) {

		return findByDefaultObjectLayout(
			defaultObjectLayout, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the object layouts where defaultObjectLayout = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ObjectLayoutModelImpl</code>.
	 * </p>
	...
	@Override
	public List<ObjectLayout> findByDefaultObjectLayout(
		boolean defaultObjectLayout, int start, int end) {

		return findByDefaultObjectLayout(defaultObjectLayout, start, end, null);
	}

	/**
	 * Returns an ordered range of all the object layouts where defaultObjectLayout = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ObjectLayoutModelImpl</code>.
	 * </p>
	...
	public List<ObjectLayout> findByDefaultObjectLayout(
		...
		return findByDefaultObjectLayout(
			defaultObjectLayout, start, end, orderByComparator, true);
	}
	...
	public List<ObjectLayout> findByDefaultObjectLayout(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindByDefaultObjectLayout;
				finderArgs = new Object[] {defaultObjectLayout};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByDefaultObjectLayout;
			finderArgs = new Object[] {
				defaultObjectLayout, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_DEFAULTOBJECTLAYOUT_DEFAULTOBJECTLAYOUT_2);
	...
	/**
	 * Returns the first object layout in the ordered set where defaultObjectLayout = &#63;.
	 *
	 * @param defaultObjectLayout the default object layout
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching object layout
	 ...
	 */
	@Override
	public ObjectLayout findByDefaultObjectLayout_First(
			boolean defaultObjectLayout,
			OrderByComparator<ObjectLayout> orderByComparator)
		throws NoSuchObjectLayoutException {

		ObjectLayout objectLayout = fetchByDefaultObjectLayout_First(
			defaultObjectLayout, orderByComparator);
	 ...
	 */
	@Override
	public ObjectLayout fetchByDefaultObjectLayout_First(
		boolean defaultObjectLayout,
		OrderByComparator<ObjectLayout> orderByComparator) {

		List<ObjectLayout> list = findByDefaultObjectLayout(
			defaultObjectLayout, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last object layout in the ordered set where defaultObjectLayout = &#63;.
	 *
	 * @param defaultObjectLayout the default object layout
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching object layout
	 ...
	 */
	@Override
	public ObjectLayout findByDefaultObjectLayout_Last(
			boolean defaultObjectLayout,
			OrderByComparator<ObjectLayout> orderByComparator)
		throws NoSuchObjectLayoutException {

		ObjectLayout objectLayout = fetchByDefaultObjectLayout_Last(
			defaultObjectLayout, orderByComparator);
	 ...
	 */
	@Override
	public ObjectLayout fetchByDefaultObjectLayout_Last(
		boolean defaultObjectLayout,
		OrderByComparator<ObjectLayout> orderByComparator) {

		int count = countByDefaultObjectLayout(defaultObjectLayout);
		...
		List<ObjectLayout> list = findByDefaultObjectLayout(
			defaultObjectLayout, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the object layouts before and after the current object layout in the ordered set where defaultObjectLayout = &#63;.
	 *
	 * @param objectLayoutId the primary key of the current object layout
	 * @param defaultObjectLayout the default object layout
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ObjectLayout[] findByDefaultObjectLayout_PrevAndNext(
		...
		try {
			...
			array[0] = getByDefaultObjectLayout_PrevAndNext(
				session, objectLayout, defaultObjectLayout, orderByComparator,
				true);

			array[1] = objectLayout;

			array[2] = getByDefaultObjectLayout_PrevAndNext(
				session, objectLayout, defaultObjectLayout, orderByComparator,
				false);
	...
	protected ObjectLayout getByDefaultObjectLayout_PrevAndNext(
		Session session, ObjectLayout objectLayout, boolean defaultObjectLayout,
		OrderByComparator<ObjectLayout> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the object layouts where defaultObjectLayout = &#63; from the database.
	 *
	 * @param defaultObjectLayout the default object layout
	 */
	@Override
	public void removeByDefaultObjectLayout(boolean defaultObjectLayout) {
		for (ObjectLayout objectLayout :
				findByDefaultObjectLayout(
					defaultObjectLayout, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	/**
	 * Returns the number of object layouts where defaultObjectLayout = &#63;.
	 *
	 * @param defaultObjectLayout the default object layout
	 * @return the number of matching object layouts
	 */
	@Override
	public int countByDefaultObjectLayout(boolean defaultObjectLayout) {
		FinderPath finderPath = _finderPathCountByDefaultObjectLayout;

		Object[] finderArgs = new Object[] {defaultObjectLayout};
	...
	private static final String
		_FINDER_COLUMN_DEFAULTOBJECTLAYOUT_DEFAULTOBJECTLAYOUT_2 =
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByDefaultObjectLayout = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByDefaultObjectLayout",
			new String[] {
				Boolean.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"defaultObjectLayout"}, true);

		_finderPathWithoutPaginationFindByDefaultObjectLayout = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByDefaultObjectLayout", new String[] {Boolean.class.getName()},
			new String[] {"defaultObjectLayout"}, true);

		_finderPathCountByDefaultObjectLayout = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByDefaultObjectLayout",
			new String[] {Boolean.class.getName()},
			new String[] {"defaultObjectLayout"}, false);
