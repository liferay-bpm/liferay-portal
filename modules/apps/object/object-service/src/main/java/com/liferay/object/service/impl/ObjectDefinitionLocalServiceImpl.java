...
import com.liferay.object.exception.ObjectDefinitionDeletionException;
...
public class ObjectDefinitionLocalServiceImpl
	...
	public ObjectDefinition deleteObjectDefinition(
		...
		_validateObjectDeletion(objectDefinition);
	...
	private void _validateObjectDeletion(ObjectDefinition objectDefinition)
		throws PortalException {

		if (objectDefinition.isApproved()) {
			throw new ObjectDefinitionDeletionException(
