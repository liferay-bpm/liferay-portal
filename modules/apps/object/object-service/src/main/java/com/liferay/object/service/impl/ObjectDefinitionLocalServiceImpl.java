...
import com.liferay.object.exception.ObjectDefinitionPanelAppOrderException;
			...
			if (!Objects.equals(
				...
				throw new ObjectDefinitionAccountEntryRestrictedException(
					"Account entry restriction " + errorMessage);
						...
						objectDefinition.getPanelAppOrder(), panelAppOrder)) {

				throw new ObjectDefinitionPanelAppOrderException(
					"Panel app order " + errorMessage);
			}
			else if (!Objects.equals(
