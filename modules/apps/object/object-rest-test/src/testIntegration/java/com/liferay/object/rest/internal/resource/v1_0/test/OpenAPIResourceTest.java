...
public class OpenAPIResourceTest {
	...
	public void testGetOpenAPIWithDescriptions() throws Exception {
			...
			ObjectDefinitionTestUtil.publishObjectDefinition(
				...
				Arrays.asList(
					...
					new MultiselectPicklistObjectFieldBuilder(
						...
						HashMapBuilder.put(
							LocaleUtil.US,
							"This is the description for the multiselect field."
						).build()
					).labelMap(
					...
					new PicklistObjectFieldBuilder(
						...
						HashMapBuilder.put(
							LocaleUtil.US,
							"This is the description for the picklist field."
						).build()
					).labelMap(
		...
		ObjectRelationshipLocalServiceUtil.addObjectRelationship(
			...
			HashMapBuilder.put(
				LocaleUtil.US,
				"This is the description for the object relationship."
			).build(),
		...
		JSONArray allOfJSONArray = picklistFieldJSONObject.getJSONArray(
			"allOf");

		JSONObject allOfJSONObject = allOfJSONArray.getJSONObject(0);

		Assert.assertEquals(
			"#/components/schemas/ListEntry",
			allOfJSONObject.getString("$ref"));
		...
		allOfJSONArray = relationshipJSONObject.getJSONArray("allOf");

		allOfJSONObject = allOfJSONArray.getJSONObject(0);
