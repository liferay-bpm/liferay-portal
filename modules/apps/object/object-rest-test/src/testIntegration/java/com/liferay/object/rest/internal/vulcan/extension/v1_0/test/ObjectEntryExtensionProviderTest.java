...
public class ObjectEntryExtensionProviderTest {
	...
	public void testGetExtendedPropertyDefinitions() throws Exception {
		...
		_assertPropertyDefinition(
			ListEntry.class.getSimpleName(), "multiselectPicklistField",
			PropertyDefinition.PropertyType.MULTIPLE_ELEMENT, false,
			extendedPropertyDefinitions.get("multiselectPicklistField"));
		_assertPropertyDefinition(
	...
	private void _testSetAndGetExtendedPropertiesWithUserAccount()
		...
		_testSetExtendedProperties(
			...
			HashMapBuilder.<String, Serializable>put(
				...
				"multiselectPicklistField",
				new String[] {"listTypeEntryKey1", "listTypeEntryKey2"}
			).put(
		...
		_testSetExtendedProperties(
			...
			HashMapBuilder.<String, Serializable>put(
				...
				"multiselectPicklistField", new String[] {"listTypeEntryKey1"}
			).put(
	...
	private void _testSetExtendedProperties(
		...
		Assert.assertEquals(
			Arrays.asList((String[])values.get("multiselectPicklistField")),
			TransformUtil.transform(
				(List<ListEntry>)extendedProperties.get(
					"multiselectPicklistField"),
				ListEntry::getKey));
