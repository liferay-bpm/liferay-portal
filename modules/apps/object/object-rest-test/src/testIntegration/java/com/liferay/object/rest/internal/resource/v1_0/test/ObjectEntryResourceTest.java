...
public class ObjectEntryResourceTest {
	...
	public void testGetObjectEntryWithAuditEvents() throws Exception {
		...
		Object originalAuditMessageProcessorEnabled =
			ReflectionTestUtil.getAndSetFieldValue(
				_auditMessageProcessor, "_enabled", Boolean.TRUE);
		...
		try {
			...
			_addModelResourcePermissions(
				new String[] {ActionKeys.VIEW, ObjectActionKeys.ENTRY_HISTORY},
			...
			// Get object entry without entry history permission
			...
			ReflectionTestUtil.setFieldValue(
				_auditMessageProcessor, "_enabled",
				originalAuditMessageProcessorEnabled);
	...
	@Inject(filter = "component.name=*.PersistentAuditMessageProcessor")
