...
public class EmailObjectFieldBusinessTypeTest {
	...
	public void testProcessValue() throws Exception {
		...
		AssertUtils.assertFailure(
			ObjectEntryValuesException.BlockedEmailDomain.class, messageString,
			() -> _objectFieldBusinessType.processValue(
		...
		AssertUtils.assertFailure(
			...
			StringBundler.concat(
				"The email domain \"@restricted.org\" is blocked for object ",
				"field \"", objectFieldWithBlockedDomains.getName(), "\""),
			() -> _objectFieldBusinessType.processValue(
