...
public class ObjectDefinitionUpgradeProcessTest {
	...
	public void testUpgrade() throws Exception {
		...
		_assertFormContainer(objectDefinition1.getObjectDefinitionId(), true);
		_assertFormContainer(objectDefinition2.getObjectDefinitionId(), true);
		_assertFormContainer(objectDefinition3.getObjectDefinitionId(), false);
	...
	private void _assertFormContainer(
		long objectDefinitionId, boolean expectResult) {
		...
		Assert.assertEquals(
			expectResult, objectDefinition.isEnableFormContainer());
	}
