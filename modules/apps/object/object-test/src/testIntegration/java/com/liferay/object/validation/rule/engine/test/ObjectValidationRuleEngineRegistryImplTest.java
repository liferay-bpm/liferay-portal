...
public class ObjectValidationRuleEngineRegistryImplTest {
	...
	@Test
	public void testShouldNotReturnObjectValidationRuleEngineScopedByAnotherCompany() {
		ServiceRegistration<ObjectValidationRuleEngine>
			objectValidationRuleEngineServiceRegistration1 = null;
		ServiceRegistration<ObjectValidationRuleEngine>
			objectValidationRuleEngineServiceRegistration2 = null;
		...
		try {
			...
			List<ObjectValidationRuleEngine> objectValidationRuleEngines =
				_objectValidationRuleEngineRegistry.
					getObjectValidationRuleEngines(1, StringUtil.randomId());

			Assert.assertFalse(
				objectValidationRuleEngines.contains(
					objectValidationRuleEngine));
		}
		finally {
	...
	@Test
	public void testShouldNotReturnObjectValidationRuleEngineScopedByAnotherObject() {
		ServiceRegistration<ObjectValidationRuleEngine>
			objectValidationRuleEngineServiceRegistration1 = null;
		...
		try {
			...
			objectValidationRuleEngineServiceRegistration1 = _register(
				objectValidationRuleEngine1);

			List<ObjectValidationRuleEngine> objectValidationRuleEngines =
				_objectValidationRuleEngineRegistry.
					getObjectValidationRuleEngines(1, "C_Department");
			...
			objectValidationRuleEngineServiceRegistration2 = _register(
				objectValidationRuleEngine2);

			objectValidationRuleEngines =
				_objectValidationRuleEngineRegistry.
					getObjectValidationRuleEngines(1, "C_Employee");
