...
public class ObjectActionLocalServiceTest {
	...
	public void testAddObjectAction() throws Exception {
		...
		try {
			...
			_executeStandaloneObjectAction(
				objectAction4.getName(), null, objectEntry.getObjectEntryId(),
				objectEntryResource);
			...
			_executeStandaloneObjectAction(
				objectAction5.getName(), objectEntry.getExternalReferenceCode(),
				objectEntry.getObjectEntryId(), objectEntryResource);
	...
	private void _executeStandaloneObjectAction(
			String objectActionName, String objectEntryExternalReferenceCode,
			long objectEntryId, ObjectEntryResource objectEntryResource)
		throws Exception {
