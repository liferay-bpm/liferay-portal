...
public class CPDefinitionSystemObjectRelatedModelsProviderTest
	...
	public void setUp() throws Exception {
		...
		_cpDefinitionLocalService.updateCPDefinitionLocalization(
			...
			"CPDefinition1Name", cpDefinition1.getShortDescription(),
			cpDefinition1.getDescription(), cpDefinition1.getMetaTitle(),
			cpDefinition1.getMetaDescription(),
			cpDefinition1.getMetaKeywords());
		_cpDefinitionLocalService.updateCPDefinitionLocalization(
			cpDefinition2, cpDefinition2.getDefaultLanguageId(),
			"CPDefinition2Name", cpDefinition2.getShortDescription(),
			cpDefinition2.getDescription(), cpDefinition2.getMetaTitle(),
			cpDefinition2.getMetaDescription(),
			cpDefinition2.getMetaKeywords());
	}
	...
	private void _testSystemObjectEntryObjectRelatedModels(
		...
		ObjectRelationshipTestUtil.assertSearchRelatedModels(
			...
			objectRelationship.getObjectRelationshipId(),
			objectEntry.getPrimaryKey(), "CPDefinition1Name");
		ObjectRelationshipTestUtil.assertSearchRelatedModels(
