...
public abstract class BaseExportImportTestCase {
	...
	public void testExportImport(
			String sourceFileName, String externalReferenceCode, String name,
		...
		byte[] bytes = _file.getBytes(
			clazz.getResourceAsStream("dependencies/" + sourceFileName));

		mockMultipartHttpServletRequest.addFile(
			new MockMultipartFile(sourceFileName, bytes));
		...
		JSONAssert.assertEquals(
			StringUtil.read(
				clazz.getResourceAsStream("dependencies/" + compareFileName)),
			String.valueOf(
