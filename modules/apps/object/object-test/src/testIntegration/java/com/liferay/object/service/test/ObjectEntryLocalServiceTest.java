...
public class ObjectEntryLocalServiceTest {
	...
	public void testAddOrUpdateObjectEntryWithFriendlyURL() throws Exception {
		...
		long classNameId = _classNameLocalService.getClassNameId(
			siteObjectDefinition.getClassName());

		Assert.assertTrue(
			ListUtil.isEmpty(
				_friendlyURLEntryLocalService.getFriendlyURLEntries(
					group1.getGroupId(), classNameId,
					siteObjectEntry1.getObjectEntryId())));
		Assert.assertTrue(
			ListUtil.isEmpty(
				_friendlyURLEntryLocalService.getFriendlyURLEntries(
					group2.getGroupId(), classNameId,
					siteObjectEntry2.getObjectEntryId())));
	}
