...
public class BoundObjectDefinitionsExportImportTest
	...
	public void testExportImportBoundObjectDefinitions() throws Exception {
		String draftBoundObjectDefinitionsJSONString = String.valueOf(
			JSONUtil.putAll(
		...
		JSONArray expectedDraftBoundObjectDefinitionsJSONArray =
			jsonFactory.createJSONArray(draftBoundObjectDefinitionsJSONString);
		...
		testExportImportJSONString(
			draftBoundObjectDefinitionsJSONString,
