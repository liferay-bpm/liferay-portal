...
public class ObjectDefinitionResourceTest
	...
	private void _testDeleteObjectDefinitionWithMassDeleteMode()
		...
		systemEvents = _systemEventLocalService.getSystemEvents(
			objectEntry.getGroupId(),
			PortalUtil.getClassNameId(
				serviceBuilderObjectDefinition.getClassName()),
			objectEntry.getObjectEntryId(), SystemEventConstants.TYPE_DELETE);

		Assert.assertTrue(systemEvents.toString(), systemEvents.isEmpty());
	}
