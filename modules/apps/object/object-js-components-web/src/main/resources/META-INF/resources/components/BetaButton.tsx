...
interface BetaButtonProps extends React.HTMLAttributes<HTMLDivElement> {
	show: boolean;
}

export function BetaButton({show}: BetaButtonProps) {
	return (
		<ClayTooltipProvider>
			<div
				...
				>
					...
					<a className="alert-link" href="#" target="_blank">
						{Liferay.Language.get(
							'learn-more-about-proxy-objects-beta-feature'
						)}
					</a>
				</ClayPopover>
			</div>
