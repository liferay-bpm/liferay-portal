...
public class ObjectDDMStorageAdapter implements DDMStorageAdapter {
	...
	private String _getValueString(
		...
		if (StringUtil.equals(
			...
			for (String rowValue : optionValueJSONObject.keySet()) {
				sb.append(
					MapUtil.getString(
				...
				sb.append(
					MapUtil.getString(
						...
						optionValueJSONObject.getString(rowValue)));
				sb.append(StringPool.COMMA_AND_SPACE);
			}
			...
			return ddmFormFieldOptions.getOptionReference(valueString);
		}
		...
		if (Objects.equals(
			...
			if (Objects.equals(
				...
				return String.valueOf(
					GetterUtil.get(
						numberFormat.parse(valueString), BigDecimal.ZERO));
			}

			return String.valueOf(
				GetterUtil.getDouble(numberFormat.parse(valueString)));
		}
