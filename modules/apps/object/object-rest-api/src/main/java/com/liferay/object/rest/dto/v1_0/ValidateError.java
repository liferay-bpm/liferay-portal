 ...
 */
@Generated("")
@GraphQLName("ValidateError")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ValidateError")
public class ValidateError implements Serializable {

	public static ValidateError toDTO(String json) {
		return ObjectMapperUtil.readValue(ValidateError.class, json);
	}

	public static ValidateError unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ValidateError.class, json);
	}
	...
	public String getValidationKey() {
		if (_validationKeySupplier != null) {
			validationKey = _validationKeySupplier.get();

			_validationKeySupplier = null;
		}
	...
	public void setValidationKey(
		UnsafeSupplier<String, Exception> validationKeyUnsafeSupplier) {

		_validationKeySupplier = () -> {
			try {
				return validationKeyUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<String> _validationKeySupplier;
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof ValidateError)) {
			return false;
		}

		ValidateError validateError = (ValidateError)object;

		return Objects.equals(toString(), validateError.toString());
	}
	...
	public String toString() {
		...
		if (validationKey != null) {
			...
			sb.append(_escape(validationKey));
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.object.rest.dto.v1_0.ValidateError",
		name = "x-class-name"
	)
