...
public class KeywordResourceTest extends BaseKeywordResourceTestCase {
	...
	public void testPutAssetLibraryKeywordByExternalReferenceCode()
		...
		_testPutAssetLibraryKeywordByExternalReferenceCodeDuplicateName();
	}
	...
	public void testPutKeywordMerge() throws Exception {
		...
		Keyword keyword6 = _postKeywordWithProjects(
			new Project() {
				{
		...
		keywordResource.putKeywordMerge(
			keyword1.getId(), new Long[] {keyword6.getId()});

		_assertSingletonProject(
			(long)GroupConstants.ANY_PARENT_GROUP_ID,
			keywordResource.getKeyword(keyword1.getId()));
	...
	private void _testPutAssetLibraryKeywordByExternalReferenceCodeDuplicateName()
		throws Exception {
