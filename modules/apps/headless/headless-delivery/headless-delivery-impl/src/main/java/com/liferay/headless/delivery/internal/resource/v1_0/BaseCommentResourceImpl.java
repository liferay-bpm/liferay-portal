...
public abstract class BaseCommentResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-delivery/v1.0/sites/{siteId}/{objectDefinitionExternalReferenceCode}/object-entry/{externalReferenceCode}/comments'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Retrieves the object entry's comments by external reference code in a list. Results can be paginated, filtered, searched, and sorted."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path(
		"/sites/{siteId}/{objectDefinitionExternalReferenceCode}/object-entry/{externalReferenceCode}/comments"
	)
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<Comment>
