...
public interface CommentResource {
	...
	public HttpInvoker.HttpResponse
			getSiteObjectDefinitionExternalReferenceCodeObjectEntryExternalReferenceCodeCommentsPageHttpResponse(
				Long siteId, String objectDefinitionExternalReferenceCode,
				String externalReferenceCode, String search,
				List<String> aggregations, String filterString,
				Pagination pagination, String sortString)
	...
	public static class CommentResourceImpl implements CommentResource {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-delivery/v1.0/sites/{siteId}/{objectDefinitionExternalReferenceCode}/object-entry/{externalReferenceCode}/comments");
