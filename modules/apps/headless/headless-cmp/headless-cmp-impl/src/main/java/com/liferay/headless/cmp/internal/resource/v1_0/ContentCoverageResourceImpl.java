...
public class ContentCoverageResourceImpl
	...
	public ContentCoverage getProjectContentCoverage(Long projectId)
		...
		booleanQuery.addFilterQueryClauses(
			_createLinkedAssetsQuery(objectEntry, projectId),
	...
	private BooleanQuery _createLinkedAssetsQuery(
			ObjectEntry objectEntry, Long projectId)
		throws Exception {

		BooleanQuery booleanQuery = QueriesUtil.booleanQuery();

		booleanQuery.addShouldQueryClauses(
			QueriesUtil.term("cmpProjectIds", projectId));

		String[] relatedTaskObjectEntryIds = _getRelatedTaskObjectEntryIds(
			objectEntry);

		if (relatedTaskObjectEntryIds.length > 0) {
			booleanQuery.addShouldQueryClauses(
				_createTermsQuery("cmpTaskIds", relatedTaskObjectEntryIds));
		}
	...
	private String[] _getRelatedTaskObjectEntryIds(ObjectEntry objectEntry)
		throws Exception {
		...
		return transformToArray(
			...
			relatedObjectEntry -> String.valueOf(
