...
public class CMPKaleoTaskInstanceTokenModelDocumentContributor
	...
	private void _contribute(
		...
		long[] cmpTaskIds = CMPLinkedObjectEntryUtil.getLinkedObjectEntryIds(
			_filterFactory, _groupLocalService, _objectDefinitionLocalService,
			objectEntry, _objectEntryLocalService, "L_CMP_TASK_LINK",
			"r_cmpTaskToCMPTaskLinks_c_cmpTaskId");

		if (cmpTaskIds.length == 0) {
			return;
		}

		document.addKeyword("cmpTaskIds", cmpTaskIds);
