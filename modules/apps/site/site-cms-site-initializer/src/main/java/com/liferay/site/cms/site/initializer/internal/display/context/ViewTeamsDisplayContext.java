...
public class ViewTeamsDisplayContext {
	...
	public ViewTeamsDisplayContext(HttpServletRequest httpServletRequest) {
	...
	public String getAPIURL() {
		return StringBundler.concat(
			...
			ObjectFolderConstants.EXTERNAL_REFERENCE_CODE_CONTENT_TEAMS,
		...
		return CreationMenuBuilder.addPrimaryDropdownItem(
			dropdownItem -> {
				dropdownItem.setHref(
					ActionUtil.getBaseTeamBuilderURL(_themeDisplay) +
						"?objectFolderExternalReferenceCode=" +
							ObjectFolderConstants.
								EXTERNAL_REFERENCE_CODE_CONTENT_TEAMS);
	...
	public List<FDSActionDropdownItem> getFDSActionDropdownItems()
		...
		return List.of(
			new FDSActionDropdownItem(
				...
				"get", "update", null),
			new FDSActionDropdownItem(
				ActionUtil.getBaseTeamUsagesURL(_themeDisplay) + "{id}",
				"list-ul", "viewUsages",
