 ...
 */
public class TeamBuilderDisplayContext {

	public TeamBuilderDisplayContext(
	...
	public Map<String, Object> getProps() throws Exception {
		return HashMapBuilder.<String, Object>put(
			...
			JSONUtil.put(
				...
				"editTeamDisplayPageURL",
				() -> StringBundler.concat(
					_themeDisplay.getPortalURL(), _themeDisplay.getPathMain(),
					"/cms/edit_team_display_page")
			).put(
				"isReferenced",
				() -> {
					ObjectDefinition objectDefinition = _getObjectDefinition();
				...
				"resetTeamDisplayPageURL",
				() -> StringBundler.concat(
					_themeDisplay.getPortalURL(), _themeDisplay.getPathMain(),
					"/cms/reset_team_display_page")
			).put(
			...
			objectDefinitionResource.getObjectDefinitionsPage(
				...
				objectDefinitionResource.toFilter(
					StringBundler.concat(
						...
						"') or (objectFolderExternalReferenceCode eq '",
						ObjectFolderConstants.
							EXTERNAL_REFERENCE_CODE_TEAM_REPEATABLE_GROUPS,
