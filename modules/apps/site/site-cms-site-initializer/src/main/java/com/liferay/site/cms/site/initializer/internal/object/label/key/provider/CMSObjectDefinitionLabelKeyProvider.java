...
public class CMSObjectDefinitionLabelKeyProvider
	...
	public String getObjectDefinitionLabelKey(String externalReferenceCode) {
		...
		return CMSObjectDefinitionKeyEnum.getLabelKey(externalReferenceCode);
	}

	public enum CMSObjectDefinitionKeyEnum {
		...
		public static String getLabelKey(String externalReferenceCode) {
			for (CMSObjectDefinitionKeyEnum value : values()) {
		...
		private CMSObjectDefinitionKeyEnum(
