 ...
 * {@code L_CMP_TASK_ASSET_RELATIONSHIP} child object entry, this listener emits
...
public class CMPTaskAssetRelationshipModelListener
	...
	private void _route(ObjectEntry objectEntry, String eventType)
		...
		try {
			...
			long cmpTaskId = GetterUtil.getLong(
				values.get("r_cmpTaskToCMPTaskAssetRelationships_c_cmpTaskId"));
