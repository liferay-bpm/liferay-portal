...
public class ViewRelatedAssetsSectionDisplayContextTest
		...
		Assert.assertTrue(
			...
			additionalAPIURLParameters.contains(
				StringBundler.concat(
					...
					"cmpTaskObjectEntryIds in (", _objectEntry.getObjectEntryId(),
	...
	public void testGetAdditionalProps() throws Exception {
		...
		Assert.assertEquals(
			...
			additionalProps.get("objectEntryLinkContext"));
	}
	...
	public void testGetCreationMenu() throws Exception {
		...
		Assert.assertEquals("/o/cmp/task-links", data.get("restContextPath"));
		...
		Assert.assertTrue(
			...
			searchAPIURL.contains(
				StringBundler.concat(
					"(cmsSection eq 'contents' or cmsSection eq 'files') and ",
					"not (cmpTaskObjectEntryIds in (", _objectEntry.getObjectEntryId(),
