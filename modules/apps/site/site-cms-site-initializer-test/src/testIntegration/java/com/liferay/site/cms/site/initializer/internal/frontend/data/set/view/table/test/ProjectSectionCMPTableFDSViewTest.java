...
package com.liferay.site.cms.site.initializer.internal.frontend.data.set.view.table.test;
...
public class ProjectSectionCMPTableFDSViewTest {
	...
	public void setUp() throws Exception {
		List<FDSView> fdsViews = _fdsViewRegistry.getFDSViews(
			"com.liferay.site.cms.site.initializer-cmp-project");
	...
	public void testGetFDSTableSchema() throws Exception {
		...
		_assertFDSTableSchemaField(
			...
			"embedded.r_projectToUserManager_userERC");
		_assertFDSTableSchemaField(
			null, "userRelationshipTableCellRenderer", "sponsor",
			"embedded.r_projectToUserSponsor_userERC");
		_assertFDSTableSchemaField(
