...
public class CMPTaskLinkModelListenerTest {
	...
	public void setUp() throws Exception {
		...
		CMPTestUtil.getOrAddGroup(CMPTaskLinkModelListenerTest.class);
	...
	private ObjectEntry _addTaskLinkObjectEntry(ObjectEntry assetObjectEntry)
		...
		ObjectDefinition objectDefinition =
			_objectDefinitionLocalService.
				getObjectDefinitionByExternalReferenceCode(
					"L_CMP_TASK_LINK", _taskObjectEntry.getCompanyId());
	...
	@Inject(
		filter = "component.name=com.liferay.site.cms.site.initializer.internal.model.listener.CMPTaskLinkModelListener"
	)
