...
public class CMPTaskAssetRelationshipModelListenerTest {
	...
	public void setUp() throws Exception {
		...
		CMPTestUtil.getOrAddGroup(
			CMPTaskAssetRelationshipModelListenerTest.class);
	...
	public void tearDown() throws Exception {
		...
		_objectEntryLocalService.deleteObjectEntry(_taskObjectEntry);
	...
	public void testOnAfterCreate() throws Exception {
		...
		_addTaskAssetRelationshipObjectEntry(_addAssetObjectEntry(title));
	...
	public void testOnAfterRemove() throws Exception {
		...
		_objectEntryLocalService.deleteObjectEntry(
			taskAssetRelationshipObjectEntry);
		...
		ObjectDefinition objectDefinition =
			_objectDefinitionLocalService.
				getObjectDefinitionByExternalReferenceCode(
					...
					_taskObjectEntry.getCompanyId());

		return _objectEntryLocalService.addObjectEntry(
			_taskObjectEntry.getGroupId(), _taskObjectEntry.getUserId(),
	...
	private void _assertAuditMessage(
		...
		Assert.assertEquals(
			_taskObjectEntry.getModelClassName(), auditMessage.getClassName());
		Assert.assertEquals(
			_taskObjectEntry.getObjectEntryId(),
	...
	@Inject(
		filter = "component.name=com.liferay.site.cms.site.initializer.internal.model.listener.CMPTaskAssetRelationshipModelListener"
	)
