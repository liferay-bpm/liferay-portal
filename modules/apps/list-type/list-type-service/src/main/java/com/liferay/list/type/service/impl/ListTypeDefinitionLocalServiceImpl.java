...
public class ListTypeDefinitionLocalServiceImpl
	...
	public ListTypeDefinition addListTypeDefinition(
		...
		_addListTypeEntries(
			listTypeEntries, listTypeDefinition.getListTypeDefinitionId(),
			userId);
	...
	public ListTypeDefinition updateListTypeDefinition(
		...
		_addListTypeEntries(listTypeEntries, listTypeDefinitionId, userId);
	...
	private void _addListTypeEntries(
			List<ListTypeEntry> listTypeEntries, long listTypeDefinitionId,
			long userId)
		throws PortalException {
