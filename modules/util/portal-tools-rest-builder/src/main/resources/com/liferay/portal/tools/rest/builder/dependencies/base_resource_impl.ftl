	...
	<#if generateGetPermissionCheckerMethods>
		...
		protected Page<com.liferay.portal.vulcan.permission.Permission> toPermissionPage(Map<String, Map<String, String>> actions, long id, String resourceName, String roleNames) throws Exception {
			...
			if (Validator.isNotNull(roleNames)) {
				return Page.of(actions, PermissionUtil.getPermissions(contextCompany.getCompanyId(), resourceActions, id, resourceName, StringUtil.split(roleNames)));
			}

			return Page.of(actions, PermissionUtil.getPermissions(contextCompany.getCompanyId(), resourceActions, id, resourceName, null));
		}
	</#if>
