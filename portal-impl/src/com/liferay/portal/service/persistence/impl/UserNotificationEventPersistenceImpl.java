...
public class UserNotificationEventPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByU_T_GteT_D_LikeP;
	private FinderPath _finderPathWithPaginationCountByU_T_GteT_D_LikeP;

	/**
	 * Returns all the user notification events where userId = &#63; and type = &#63; and timestamp &ge; &#63; and delivered = &#63; and payload LIKE &#63;.
	 *
	 * @param userId the user ID
	 * @param type the type
	 ...
	 */
	@Override
	public List<UserNotificationEvent> findByU_T_GteT_D_LikeP(
		long userId, String type, long timestamp, boolean delivered,
		String payload) {

		return findByU_T_GteT_D_LikeP(
			userId, type, timestamp, delivered, payload, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the user notification events where userId = &#63; and type = &#63; and timestamp &ge; &#63; and delivered = &#63; and payload LIKE &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>UserNotificationEventModelImpl</code>.
	 * </p>
	...
	public List<UserNotificationEvent> findByU_T_GteT_D_LikeP(
		long userId, String type, long timestamp, boolean delivered,
		String payload, int start, int end) {

		return findByU_T_GteT_D_LikeP(
			userId, type, timestamp, delivered, payload, start, end, null);
	}

	/**
	 * Returns an ordered range of all the user notification events where userId = &#63; and type = &#63; and timestamp &ge; &#63; and delivered = &#63; and payload LIKE &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>UserNotificationEventModelImpl</code>.
	 * </p>
	...
	public List<UserNotificationEvent> findByU_T_GteT_D_LikeP(
		...
		return findByU_T_GteT_D_LikeP(
			userId, type, timestamp, delivered, payload, start, end,
			orderByComparator, true);
	}
	...
	public List<UserNotificationEvent> findByU_T_GteT_D_LikeP(
		...
		finderPath = _finderPathWithPaginationFindByU_T_GteT_D_LikeP;
		finderArgs = new Object[] {
			userId, type, timestamp, delivered, payload, start, end,
			orderByComparator
		};
				...
				for (UserNotificationEvent userNotificationEvent : list) {
					if ((userId != userNotificationEvent.getUserId()) ||
						...
						!StringUtil.wildcardMatches(
							userNotificationEvent.getPayload(), payload, '_',
							'%', '\\', true)) {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_U_T_GTET_D_LIKEP_USERID_2);

			boolean bindType = false;

			if (type.isEmpty()) {
				sb.append(_FINDER_COLUMN_U_T_GTET_D_LIKEP_TYPE_3);
			}
			else {
				bindType = true;

				sb.append(_FINDER_COLUMN_U_T_GTET_D_LIKEP_TYPE_2);
			}

			sb.append(_FINDER_COLUMN_U_T_GTET_D_LIKEP_TIMESTAMP_2);

			sb.append(_FINDER_COLUMN_U_T_GTET_D_LIKEP_DELIVERED_2);

			boolean bindPayload = false;

			if (payload.isEmpty()) {
				sb.append(_FINDER_COLUMN_U_T_GTET_D_LIKEP_PAYLOAD_3);
			}
			else {
				bindPayload = true;

				sb.append(_FINDER_COLUMN_U_T_GTET_D_LIKEP_PAYLOAD_2);
			}
	...
	/**
	 * Returns the first user notification event in the ordered set where userId = &#63; and type = &#63; and timestamp &ge; &#63; and delivered = &#63; and payload LIKE &#63;.
	 *
	 * @param userId the user ID
	 * @param type the type
	 * @param timestamp the timestamp
	 ...
	 */
	@Override
	public UserNotificationEvent findByU_T_GteT_D_LikeP_First(
			long userId, String type, long timestamp, boolean delivered,
			String payload,
			OrderByComparator<UserNotificationEvent> orderByComparator)
		throws NoSuchUserNotificationEventException {
		...
		UserNotificationEvent userNotificationEvent =
			fetchByU_T_GteT_D_LikeP_First(
				userId, type, timestamp, delivered, payload, orderByComparator);
	 ...
	 */
	@Override
	public UserNotificationEvent fetchByU_T_GteT_D_LikeP_First(
		long userId, String type, long timestamp, boolean delivered,
		String payload,
		OrderByComparator<UserNotificationEvent> orderByComparator) {

		List<UserNotificationEvent> list = findByU_T_GteT_D_LikeP(
			userId, type, timestamp, delivered, payload, 0, 1,
			orderByComparator);
	...
	/**
	 * Returns the last user notification event in the ordered set where userId = &#63; and type = &#63; and timestamp &ge; &#63; and delivered = &#63; and payload LIKE &#63;.
	 *
	 * @param userId the user ID
	 * @param type the type
	 * @param timestamp the timestamp
	 ...
	 */
	@Override
	public UserNotificationEvent findByU_T_GteT_D_LikeP_Last(
			long userId, String type, long timestamp, boolean delivered,
			String payload,
			OrderByComparator<UserNotificationEvent> orderByComparator)
		throws NoSuchUserNotificationEventException {
	 ...
	 */
	@Override
	public UserNotificationEvent fetchByU_T_GteT_D_LikeP_Last(
		long userId, String type, long timestamp, boolean delivered,
		String payload,
		OrderByComparator<UserNotificationEvent> orderByComparator) {

		int count = countByU_T_GteT_D_LikeP(
		...
		List<UserNotificationEvent> list = findByU_T_GteT_D_LikeP(
			userId, type, timestamp, delivered, payload, count - 1, count,
			orderByComparator);
	...
	/**
	 * Returns the user notification events before and after the current user notification event in the ordered set where userId = &#63; and type = &#63; and timestamp &ge; &#63; and delivered = &#63; and payload LIKE &#63;.
	 *
	 * @param userNotificationEventId the primary key of the current user notification event
	 * @param userId the user ID
	 * @param type the type
	 ...
	 */
	@Override
	public UserNotificationEvent[] findByU_T_GteT_D_LikeP_PrevAndNext(
			long userNotificationEventId, long userId, String type,
			long timestamp, boolean delivered, String payload,
			OrderByComparator<UserNotificationEvent> orderByComparator)
		throws NoSuchUserNotificationEventException {
		...
		try {
			...
			array[0] = getByU_T_GteT_D_LikeP_PrevAndNext(
				session, userNotificationEvent, userId, type, timestamp,
				delivered, payload, orderByComparator, true);

			array[1] = userNotificationEvent;

			array[2] = getByU_T_GteT_D_LikeP_PrevAndNext(
				session, userNotificationEvent, userId, type, timestamp,
				delivered, payload, orderByComparator, false);
	...
	protected UserNotificationEvent getByU_T_GteT_D_LikeP_PrevAndNext(
		Session session, UserNotificationEvent userNotificationEvent,
		long userId, String type, long timestamp, boolean delivered,
		String payload,
		OrderByComparator<UserNotificationEvent> orderByComparator,
	...
	/**
	 * Removes all the user notification events where userId = &#63; and type = &#63; and timestamp &ge; &#63; and delivered = &#63; and payload LIKE &#63; from the database.
	 *
	 * @param userId the user ID
	 * @param type the type
	 * @param timestamp the timestamp
	 ...
	 */
	@Override
	public void removeByU_T_GteT_D_LikeP(
		long userId, String type, long timestamp, boolean delivered,
		String payload) {

		for (UserNotificationEvent userNotificationEvent :
				findByU_T_GteT_D_LikeP(
					userId, type, timestamp, delivered, payload,
					QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	...
	/**
	 * Returns the number of user notification events where userId = &#63; and type = &#63; and timestamp &ge; &#63; and delivered = &#63; and payload LIKE &#63;.
	 *
	 * @param userId the user ID
	 * @param type the type
	 * @param timestamp the timestamp
	 ...
	 */
	@Override
	public int countByU_T_GteT_D_LikeP(
		long userId, String type, long timestamp, boolean delivered,
		String payload) {
		...
		FinderPath finderPath =
			_finderPathWithPaginationCountByU_T_GteT_D_LikeP;
	...
	private static final String _FINDER_COLUMN_U_T_GTET_D_LIKEP_USERID_2 =
		"userNotificationEvent.userId = ? AND ";

	private static final String _FINDER_COLUMN_U_T_GTET_D_LIKEP_TYPE_2 =
		"userNotificationEvent.type = ? AND ";

	private static final String _FINDER_COLUMN_U_T_GTET_D_LIKEP_TYPE_3 =
		"(userNotificationEvent.type IS NULL OR userNotificationEvent.type = '') AND ";

	private static final String _FINDER_COLUMN_U_T_GTET_D_LIKEP_TIMESTAMP_2 =
		"userNotificationEvent.timestamp >= ? AND ";

	private static final String _FINDER_COLUMN_U_T_GTET_D_LIKEP_DELIVERED_2 =
		"userNotificationEvent.delivered = ? AND ";

	private static final String _FINDER_COLUMN_U_T_GTET_D_LIKEP_PAYLOAD_2 =
		"CAST_CLOB_TEXT(userNotificationEvent.payload) LIKE ?";

	private static final String _FINDER_COLUMN_U_T_GTET_D_LIKEP_PAYLOAD_3 =
		"(userNotificationEvent.payload IS NULL OR CAST_CLOB_TEXT(userNotificationEvent.payload) LIKE '')";
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindByU_T_GteT_D_LikeP = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByU_T_GteT_D_LikeP",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName(), Integer.class.getName(),
			...
			new String[] {
				"userId", "type_", "timestamp", "delivered", "payload"
			},
			true);

		_finderPathWithPaginationCountByU_T_GteT_D_LikeP = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByU_T_GteT_D_LikeP",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Long.class.getName(), Boolean.class.getName(),
