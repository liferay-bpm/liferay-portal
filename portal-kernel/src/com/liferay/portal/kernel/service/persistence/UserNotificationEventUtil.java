...
public class UserNotificationEventUtil {
	 ...
	 * @return the matching user notification events
	 */
	public static List<UserNotificationEvent> findByU_T_GteT_D_LikeP(
		long userId, String type, long timestamp, boolean delivered,
		String payload) {

		return getPersistence().findByU_T_GteT_D_LikeP(
	 ...
	 * @throws NoSuchUserNotificationEventException if a matching user notification event could not be found
	 */
	public static UserNotificationEvent findByU_T_GteT_D_LikeP_First(
			long userId, String type, long timestamp, boolean delivered,
			String payload,
			OrderByComparator<UserNotificationEvent> orderByComparator)
		throws com.liferay.portal.kernel.exception.
		...
		return getPersistence().findByU_T_GteT_D_LikeP_First(
	 ...
	 * @return the first matching user notification event, or <code>null</code> if a matching user notification event could not be found
	 */
	public static UserNotificationEvent fetchByU_T_GteT_D_LikeP_First(
		long userId, String type, long timestamp, boolean delivered,
		String payload,
		OrderByComparator<UserNotificationEvent> orderByComparator) {

		return getPersistence().fetchByU_T_GteT_D_LikeP_First(
			userId, type, timestamp, delivered, payload, orderByComparator);
	}
	 ...
	 * @throws NoSuchUserNotificationEventException if a matching user notification event could not be found
	 */
	public static UserNotificationEvent findByU_T_GteT_D_LikeP_Last(
			long userId, String type, long timestamp, boolean delivered,
			String payload,
			OrderByComparator<UserNotificationEvent> orderByComparator)
		throws com.liferay.portal.kernel.exception.
		...
		return getPersistence().findByU_T_GteT_D_LikeP_Last(
			userId, type, timestamp, delivered, payload, orderByComparator);
	}
	 ...
	 * @return the last matching user notification event, or <code>null</code> if a matching user notification event could not be found
	 */
	public static UserNotificationEvent fetchByU_T_GteT_D_LikeP_Last(
		long userId, String type, long timestamp, boolean delivered,
		String payload,
		OrderByComparator<UserNotificationEvent> orderByComparator) {

		return getPersistence().fetchByU_T_GteT_D_LikeP_Last(
			userId, type, timestamp, delivered, payload, orderByComparator);
	}
	 ...
	 * @throws NoSuchUserNotificationEventException if a user notification event with the primary key could not be found
	 */
	public static UserNotificationEvent[] findByU_T_GteT_D_LikeP_PrevAndNext(
			long userNotificationEventId, long userId, String type,
		...
		return getPersistence().findByU_T_GteT_D_LikeP_PrevAndNext(
			userNotificationEventId, userId, type, timestamp, delivered,
			payload, orderByComparator);
	}
	 ...
	 * @param payload the payload
	 */
	public static void removeByU_T_GteT_D_LikeP(
		long userId, String type, long timestamp, boolean delivered,
		String payload) {

		getPersistence().removeByU_T_GteT_D_LikeP(
			userId, type, timestamp, delivered, payload);
	}
	 ...
	 * @return the number of matching user notification events
	 */
	public static int countByU_T_GteT_D_LikeP(
		long userId, String type, long timestamp, boolean delivered,
		String payload) {

		return getPersistence().countByU_T_GteT_D_LikeP(
			userId, type, timestamp, delivered, payload);
	}
